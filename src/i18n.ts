...
const en: Strings = {
  ...
  toggleIntraDay:     '🔄 Repeat during the day',
  ...
  mobileBody:        '⚠️ On mobile devices, system notifications work ONLY while the Obsidian app is open and active on screen.',
...
const ru: Strings = {
  ...
  toggleIntraDay:     '🔄 Повторять в течение дня',
