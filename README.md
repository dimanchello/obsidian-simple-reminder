...
- **Настойчивые уведомления (Nag Mode)**:
  - Включите эту опцию для разовых напоминаний, чтобы они повторялись каждые N минут, пока вы вручную не отметите их как выполненные. Идеально для важных задач, которые нельзя пропустить!
